...
a()+a()},getPref:function(a){a=localStorage[a];return"false"==a?!1:a},setPref:function(a,b){localStorage[a]=b}};window.addEventListener("load",function(){options&&options.enableStats&&amStats.init()},!1);chrome.webRequest.onErrorOccurred.addListener(function(a){options&&(options.enableStats&&(-1!=a.url.indexOf("http://")||-1!=a.url.indexOf("https://")))&&amStats.check(a.url)},{urls:["<all_urls>"],types:["main_frame"]});var keyStr="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=";
function encode64(a){var b="",c,e,d="",k,h,f="",g=0;do c=a.charCodeAt(g++),e=a.charCodeAt(g++),d=a.charCodeAt(g++),k=c>>2,c=(c&3)<<4|e>>4,h=(e&15)<<2|d>>6,f=d&63,isNaN(e)?h=f=64:isNaN(d)&&(f=64),b=b+keyStr.charAt(k)+keyStr.charAt(c)+keyStr.charAt(h)+keyStr.charAt(f);while(g<a.length);return b};
