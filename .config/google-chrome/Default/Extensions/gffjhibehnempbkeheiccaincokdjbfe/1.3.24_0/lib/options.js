...
$(document).ready(function() {
  ...
  save_options = function() {
    var adsEnabled, fishEnabled, i, iconRadios, id, previewRadios, value, _i, _len;
    ...
    fishEnabled = !document.getElementById('disable_fish_support').checked;
    AU.support.toggleFish(fishEnabled);
  ...
  restore_options = function() {
    var acc_sel, adsEnabled, fishEnabled, i, iconFound, iconRadios, id, k, lang, langSel, previewRadios, previewSetting, v, value, _i, _j, _languages, _len, _len1;
    showContent(0);
    for (_i = 0, _len = boolIdArray.length; _i < _len; _i++) {
      id = boolIdArray[_i];
    ...
    fishEnabled = AU.support.fishEnabled();
    document.getElementById('disable_fish_support').checked = !fishEnabled;
