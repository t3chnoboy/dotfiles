...
function ambilightfunction(){
		...
		if(youtubemovieplayer){ youtubemovieplayer.style.overflow = "visible"; } // show the overflow out the video element
...
try {
	if(playerid.paused || playerid.ended || $("movie_player").getPlayerState() != 1){
	// animation go out
