// declare package:templates.control.newsfeed
templates=templates || {};
templates.control=templates.control || {};
templates.control.newsfeed=templates.control.newsfeed || {};
(function(){
var _L=devhd.i18n.L,$L=devhd.i18n.$L,$=[],$E="",$P=templates.control.newsfeed;
