// declare package:templates.control.entryMessageArea
templates=templates || {};
templates.control=templates.control || {};
templates.control.entryMessageArea=templates.control.entryMessageArea || {};
(function(){
var _L=devhd.i18n.L,$L=devhd.i18n.$L,$=[],$E="",$P=templates.control.entryMessageArea;
