// declare package:templates.control.timeline
templates=templates || {};
templates.control=templates.control || {};
templates.control.timeline=templates.control.timeline || {};
(function(){
var _L=devhd.i18n.L,$L=devhd.i18n.$L,$=[],$E="",$P=templates.control.timeline;
