// declare package:templates.control.banner
templates=templates || {};
templates.control=templates.control || {};
templates.control.banner=templates.control.banner || {};
(function(){
var _L=devhd.i18n.L,$L=devhd.i18n.$L,$=[],$E="",$P=templates.control.banner;
