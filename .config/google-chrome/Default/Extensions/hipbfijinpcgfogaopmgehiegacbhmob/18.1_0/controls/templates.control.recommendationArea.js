// declare package:templates.control.recommendationArea
templates=templates || {};
templates.control=templates.control || {};
templates.control.recommendationArea=templates.control.recommendationArea || {};
(function(){
var _L=devhd.i18n.L,$L=devhd.i18n.$L,$=[],$E="",$P=templates.control.recommendationArea;
