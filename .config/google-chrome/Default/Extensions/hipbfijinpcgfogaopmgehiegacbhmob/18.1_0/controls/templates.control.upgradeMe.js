// declare package:templates.control.upgradeMe
templates=templates || {};
templates.control=templates.control || {};
templates.control.upgradeMe=templates.control.upgradeMe || {};
(function(){
var _L=devhd.i18n.L,$L=devhd.i18n.$L,$=[],$E="",$P=templates.control.upgradeMe;
